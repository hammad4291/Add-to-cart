let body = document.querySelector("body");
        ...
        const products = async () => {
            ...
            goBack.forEach((button) => {
                button.addEventListener("click", () => {
                    inventoryList.style.transform = "translateX(100%)"; // Move inventory-list back to its initial position
                    inventory.style.display = "none";
                });
            });
        }
        ...
        function createElement(element) {
            ...
            //     // inventoryList.style.transform = "translateX(-200%)"; // Move inventory-list onto the screen
